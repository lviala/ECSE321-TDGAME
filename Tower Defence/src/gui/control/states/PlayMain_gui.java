...
public class PlayMain_gui extends GUIState {
    ...
    public void init() {
        ...
        addElement(new DoublePNGButton(SLOW_TOWER_BUTTON_ID, new vec2(350, 600), Textures.SLOW_BUTTON_IDLE, Textures.SLOW_BUTTON_MOUSEOVER, Textures.SLOW_BUTTON_DOWN));
        addElement(new DoublePNGButton(RAPID_TOWER_BUTTON_ID, new vec2(500, 600), Textures.RAPID_BUTTON_IDLE, Textures.RAPID_BUTTON_MOUSEOVER, Textures.RAPID_BUTTON_DOWN));
